...
files = glob.glob("C:/Users/Burak/Desktop/NewNucleiDetectionOrganized/masks/*.png") # create a list of the files, in this case we're only interested in files which have masks so we can use supervised learning
    ...
    for filei in phases[phase]:  # now for each of the files
        ...
        for imgtype in imgtypes:
            if (
                ...
                io = cv2.cvtColor(cv2.imread("C:/Users/Burak/Desktop/NewNucleiDetectionOrganized/" + os.path.basename(fname).replace("_mask.png", ".png")),
                                  cv2.COLOR_BGR2RGB)
